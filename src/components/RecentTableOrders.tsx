...
import { MdHistory, MdTableBar, MdPerson, MdOutlineRestaurantMenu, MdAccessTime, MdOutlineInfo } from 'react-icons/md';
                        ...
                        <div key={order.id} className="bg-white border border-gray-100 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden">
                            <div className="flex items-center justify-between p-4 border-b border-gray-100">
                                ...
                                <div className="flex flex-col items-end">
                                    <span className="px-2 py-1 text-xs font-medium rounded-full bg-green-50 text-green-600 mb-1">
                                        {order.status}
                                    </span>
                            ...
                            <div className="px-4 py-3 border-t border-gray-100 flex justify-between items-center">
                                <div className="text-sm">
                                    ...
                                    <span className="font-medium text-gray-900">₹{calculateTotal(order.order_items).toFixed(2)}</span>
                                </div>
                                <button
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-4">
                    <div className="bg-white rounded-xl p-6 shadow-xl max-w-md w-full max-h-[90vh] overflow-hidden flex flex-col">
                        ...
                        <div className="mt-4 pt-3 border-t border-gray-100">
                            ...
                            <div className="flex justify-between items-center font-medium text-base mt-2">
                                <span>Total Amount:</span>
                                <span className="text-primary">₹{calculateTotal(selectedOrder.order_items).toFixed(2)}</span>
                            </div>
                        </div>
                    </div>
                </div>
