...
const sampleData = [
    { name: 'Apples', quantity: 10, unit: 'kg', amount: 5 ,id:'#CFG758',price: '₹10',bill:'₹100'},
    { name: 'Bananas form banaras, mangoe', quantity: 20, unit: 'kg', amount: 10,id:'#CFG478',price: '₹10',bill:'₹100' },
    { name: 'Oranges', quantity: 15, unit: 'kg', amount: 5,id:'#CFG788',price: '₹10',bill:'₹100' },
    { name: 'Mangoes', quantity: 25, unit: 'kg', amount: 10,id:'#CFG786',price: '₹10',bill:'₹100' },
    { name: 'Grapes', quantity: 30, unit: 'kg', amount: 15 ,id:'#CFG787',price: '₹10',bill:'₹100'},
]
