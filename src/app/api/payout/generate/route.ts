...
export async function GET() {
    ...
    try {
        ...
        /**
         * Formula: amount = (salary / 30) * total_present_days_in_previous_month + balance
         */
